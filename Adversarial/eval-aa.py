...
log_path = LOG_DIR + '/log-aa-BS512.log'
...
model = create_model(args.model, args.normalize, info, device,coesB=[-1,0],learn=args.learn,IniRes=args.IniRes,Mask=args.Mask,IniCh=args.IniCh,settings=args.settings,IniDecay=args.IniDecay)
print(args.learn,args.IniRes,args.Mask,args.IniCh,args.settings,args.IniDecay)

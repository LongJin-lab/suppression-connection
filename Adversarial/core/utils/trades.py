...
def trades_loss(model, x_natural, y, optimizer_NoCoe, optimizer_Coe, step_size=0.003, epsilon=0.031, perturb_steps=10, beta=1.0, 
                attack='linf-pgd'):
    """
...
def trades_loss_LSE(model, x_natural, y, optimizer_NoCoe, optimizer_Coe, step_size=0.003, epsilon=0.031, perturb_steps=10, beta=1.0, 

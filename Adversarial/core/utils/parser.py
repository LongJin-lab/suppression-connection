...
def parser_train():
    ...
    parser.add_argument('-m', '--model', choices=MODELS, default='nrn-28-1-swish-learn', help='Model architecture to be used.')
    ...
    parser.add_argument('-na', '--num-adv-epochs', type=int, default=20, help='Number of adversarial training epochs.')
    ...
    parser.add_argument('--settings', default='ShareExpDecayLearnDecay_AbsExp_Ini0p5_RestaLayerIdx3', type=str)#Default#ShareExpDecayLearnDecay_AbsExp_Ini0p5_RestaLayerIdx3
    parser.add_argument('--IniDecay', default=0.5, type=float)
    parser.add_argument("--CoesLR", default=0.001, type=float, help="")#0.001
...
def parser_eval():
    ...
    parser.add_argument('--settings', default='ShareExpDecayLearnDecay_AbsExp_Ini0p5_RestaLayerIdx3', type=str)#Default#ShareExpDecayLearnDecay_AbsExp_Ini0p5_RestaLayerIdx3
    parser.add_argument('--IniDecay', default=0.5, type=float)
    parser.add_argument("--CoesLR", default=0.001, type=float, help="")    
    return parser

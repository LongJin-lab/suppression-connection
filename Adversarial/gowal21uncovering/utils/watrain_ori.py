...
class WATrainer(Trainer):
    ...
    def init_optimizer(self, num_epochs):
        ...
        self.optimizer_NoCoe = torch.optim.SGD(group_weight(self.model), lr=self.params.lr, weight_decay=self.params.weight_decay, momentum=0.9, nesterov=self.params.nesterov)
        self.optimizer_Coe = None
        if num_epochs <= 0:
            return
